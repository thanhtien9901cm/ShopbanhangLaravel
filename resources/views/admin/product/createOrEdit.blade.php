                        ...
                        <form id="form-product" class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{route('admin.product.store')}}">
                            ...
                            <div class="form-group row">
                              <div class="col-sm-4">
                                  ...
                                  <div class="custom-file">
                                      <input type="file" name="image" @if($flag) value="{{$primary}}" @endif accept=".jpg, .jpeg, .png ,.webp" class="custom-file-input img-pro" id="file" data-toggle="tooltip" title="{{!empty($primary->name) ? $primary->name : 'Chọn ảnh'}} " data-placement="bottom">
